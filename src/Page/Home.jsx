...
const Home = () => {
  return (
    ...
    <section>
        ...
        <p1 className= 'text-blue-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum officia itaque dolore neque? Perspiciatis ea doloribus dolor saepe, 
        ...
        <p1 className='text-pretty bg-slate-600 text-white'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi ullam eius maiores consequatur, 
